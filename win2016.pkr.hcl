...
variable "autounattend" {
  type    = string
  default = "./answer_files/2016-standard/Autounattend.xml"
}
...
build {
  sources = ["source.qemu.win2016"]
  # We do this a bit backwards - because 2016 will install dotnet 4.8 as part of choco
